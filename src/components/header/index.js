...
const Header = ({ drawerClickHandler, loginModalClickHandler }) => {
  ...
  if (isSmallMobile) {
    return (
      <div className="header">
        <a href={homeUrl}>
          <img className="logo" src={WhiteIcon} alt={logoAlt} />
        </a>
        <img
          className="menu"
          src={MenuSVG}
    ...
    return (
      <div className="header">
        <a href={homeUrl}>
          <img className="logo" src={WhiteLogo} alt={logoAlt} />
        </a>
        <img
          className="menu"
          src={MenuSVG}
    ...
    return (
      <div className="header">
        <a href={homeUrl}>
          <img className="logo" src={GreenLogo} alt={logoAlt} />
        </a>
        <Menu {...menuItems} loginModalClickHandler={loginModalClickHandler} />
      </div>
    );
  } else if (isDesktop) {
    return (
